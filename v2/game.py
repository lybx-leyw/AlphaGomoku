...
from src.level5 import mcts_search as mcts_search_level5
...
#0.载入AI模型
model = trick_net()
print("AI难度介绍：1-简单决策AI，2-激进决策AI，3-平衡决策AI，4-MCTS深度思考AI，5-MCTS平衡型AI")
level = int(input("请输入难度（1/2/3/4/5）"))
